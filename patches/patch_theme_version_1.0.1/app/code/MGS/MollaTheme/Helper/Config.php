...
class Config extends \MGS\ThemeSettings\Helper\Config
{
	...
	public function getThemeSettingStyle($storeId){
		...
		if($colorPrimary!=''){
			...
			$html .= '.bg-primary-hover:hover, .btn-outline-gray:hover, .btn-default-white:hover, .btn-default-dark:hover, .btn-default:hover  {color: #fff !important; border-color: '.$colorPrimary.' !important; background-color: '.$colorPrimary.' !important}';
		...
		if($this->getStoreConfig('themesettings/header/custom_middle_header', $storeId)){
			...
			if($middleHeaderLinkColor!=''){
				$html .= 'header .header-area .middle-header a{color:'.$middleHeaderLinkColor.';}';
			}
			if($middleHeaderLinkHoverColor!=''){
				$html .= 'header .header-area .middle-header a:hover{color:'.$middleHeaderLinkHoverColor.';}';
			}
		...
		if($this->getStoreConfig('themesettings/header/mini_cart_custom', $storeId)){
			...
			if($miniCartIconColor!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper a.action.showcart::before{color:'.$miniCartIconColor.';}';
			}
			if($miniCartIconHoverColor!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper a.action.showcart:hover::before{color:'.$miniCartIconHoverColor.';}';
			}
			...
			if($miniCartNumberColor!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper a.action.showcart .counter.qty{color:'.$miniCartNumberColor.';}';
			}
			...
			if($miniCartNumberBackground!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper a.action.showcart .counter.qty{background:'.$miniCartNumberBackground.';}';
			}
			...
			if($miniCartHeadingColor!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper .top-cart-title, .page-header .header-area .minicart-wrapper .block-minicart .subtotal .label{color:'.$miniCartHeadingColor.';}';
			}
			...
			if($miniCartBackgroundColor!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper.active .block-minicart{background:'.$miniCartBackgroundColor.';}';
			}
			...
			if($miniCartCloseColor!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper .block-content .action.close, header.page-header .minicart-wrapper .block-content .action.close:before{color:'.$miniCartCloseColor.';}';
			}
			...
			if($miniCartDivideBorderColor!=''){
				$html .= 'header.page-header .header-area .minicart-wrapper .top-cart-title, header.page-header .minicart-wrapper .minicart-items-wrapper .product-item+.product-item{border-color:'.$miniCartDivideBorderColor.';}';
			}
		}
		...
		if($this->getStoreConfig('themesettings/main/custom_text_link', $storeId)){
			...
			if($mainLinkHoverColor!=''){
				...
				$html .= '.locator-index-index .store-list-container .store-list .store-list-items .action-toolbar .pager .pages-items .item.pages-item-next .action:hover {background-color: '. $mainLinkHoverColor .' !important}';
